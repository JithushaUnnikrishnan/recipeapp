...
class Editmyreci extends StatefulWidget {
  const Editmyreci({super.key, required this. id});
  final id;

  @override
  State<Editmyreci> createState() => _EditmyreciState();
}

class _EditmyreciState extends State<Editmyreci> {
  ...
  Future<void> Addreci() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection("Addrecipe").doc(widget.id).update({
